...
addToDOButton.addEventListener("click", function () {
  ...
  pending.innerHTML = `
  <div class="todo-task">
    <h4>${inputField.value}</h4>
    <div class="action-btn-container">
        <svg id="${inputField.value}" xmlns="http://www.w3.org/2000/svg" width="1em" height="1em"
            preserveAspectRatio="xMidYMid meet" viewBox="0 0 24 24">
            <path fill="currentColor"
                d="M9.525 18.025q-.5.325-1.013.037Q8 17.775 8 17.175V6.825q0-.6.512-.888q.513-.287 1.013.038l8.15 5.175q.45.3.45.85t-.45.85Z" />
        </svg>
  ...
  var temp1 = inputField.value;
  inputField.value = "";
  var svgPause = document.getElementById(temp1);
  svgPause.addEventListener("click", (e) => {
    let inProgress = document.createElement("div");
    inProgress.setAttribute("id", temp1 + "pri");
    ...
    <div class="action-btn-container">
        ...
        <svg id="${temp1}" xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" preserveAspectRatio="xMidYMid meet"
            viewBox="0 0 24 24">
            <rect x="0" y="0" width="24" height="24" fill="none" stroke="none" />
            <path fill="currentColor"
                d="M5 21q-.825 0-1.413-.587Q3 19.825 3 19V5q0-.825.587-1.413Q4.175 3 5 3h14q.825 0 1.413.587Q21 4.175 21 5v14q0 .825-.587 1.413Q19.825 21 19 21Zm0-2h14V5H5v14Z" />
    ...
    var svgTick = document.getElementById(temp1);

    svgTick.addEventListener("click", (e) => {
      let completed = document.createElement("div");
      completed.setAttribute("id", temp1 + "pri");
